...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_param_BaseCGRA', [dirname(__file__)])
        except ImportError:
            import _param_BaseCGRA
            return _param_BaseCGRA
        if fp is not None:
            try:
                _mod = imp.load_module('_param_BaseCGRA', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _param_BaseCGRA = swig_import_helper()
...
class BaseCGRA(m5.internal.param_BaseCPU.BaseCPU):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
BaseCGRA_swigregister = _param_BaseCGRA.BaseCGRA_swigregister
BaseCGRA_swigregister(BaseCGRA)

class BaseCGRAParams(m5.internal.param_BaseCPU.BaseCPUParams):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self): 
        this = _param_BaseCGRA.new_BaseCGRAParams()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _param_BaseCGRA.delete_BaseCGRAParams
    __del__ = lambda self : None;
BaseCGRAParams_swigregister = _param_BaseCGRA.BaseCGRAParams_swigregister
BaseCGRAParams_swigregister(BaseCGRAParams)
